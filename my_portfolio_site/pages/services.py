...
def pricing_pilots_page() -> rx.Component:
    return rx.box(
        rx.vstack(
            ...
            rx.text(
                "Start small. Scale smart. Future-proof your lab’s knowledge with flexible, modular solutions.",
                font_size="1.25rem",
                text_align="center",
                max_width="800px",
                margin_x="auto",
            ...
            # Optional Add-Ons
            rx.box(
                rx.heading("Optional Add-Ons", font_size="1.5rem", margin_top="2rem"),
                rx.text(
            ...
            # Benefits Section
            rx.box(
                rx.heading("Key Benefits", font_size="1.5rem", margin_top="2rem"),
                rx.list(
                    rx.list_item(
...
def tier_card(title: str, duration: str, price: str, bullets: list[str], note: str, highlight: bool) -> rx.Component:
    ...
    return rx.box(
        rx.heading(title, font_size="1.5rem"),
        rx.text(f"Duration: {duration}  |  Price: {price}", font_size="1rem", margin_top="0.5rem"),
